...
#show: ieee.with(
	title: [CLX Main Memory Compression aware Tiered Cuckoo Hash Map],
	abstract: [
		Curent Cuckoo Hashs do not take advantage of CLX Main Memory Compression. In this paper, I proprose a restructuring the multiple tables in a Cuckoo Hash to take advantage Main Memory Compression. This Tiered Cuckoo Hash Map keeps data densely packed in smaller tables to allow larger compressed tables to take extra values.
	],
	authors: (
		(
...
#align(center, table(
	...
	[$S_(k v)$], [Size of a single KV pair (8B key)], [56B],
